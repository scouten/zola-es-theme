...
- **Flight videos**: once the reader plays a video from a flight leg that has a clip (`docs/track-format.md` §2.6), the dot, traveled portion, and progress bar follow the video, and the caption shows the speed and altitude ("Flying · 198 km/h / 123 mph" over "Altitude 610 m / 2,000 ft"). Pausing holds the map where the video is; scrolling to another item returns it to following the article.
