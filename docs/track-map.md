...
- **Direction arrows**: a small chevron just ahead of each photo dot and of the position dot points the way the traveller went next, in the dot's colour. None at the end of the track, and none on photos that share a cluster with others.
