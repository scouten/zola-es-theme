...
- **Badge at the position dot**: in the docked and expanded views, a small badge beside the dot, tied to it by a short funnel, repeats the caption's icon, mode, distance and label. It sits to the side the traveller came from when the track allows, and hides while a photo card is up.
