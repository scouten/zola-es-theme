...
- **Parks**: a page can highlight parks, with a subtle greyed-sand tint under the track and no outline, so nothing competes with the track lines, and zooming to the whole day takes them in. See *Highlighting a park* under *Migrating a page*, above.
