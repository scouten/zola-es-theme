...
- **Badge at photo-less points**: in the docked and expanded views, when the position dot is not at a photo (a leg's start when stepping through legs, the end of the track), a small badge beside the dot repeats the caption's icon, mode, distance and label. It hides while a photo card is up.
