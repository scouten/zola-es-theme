...
(function () {
  ...
  let tripDays = 1;
  let PARKS = [];  // the parks the page highlights (the JSON's `parks`): their outlines are shaded under the track  // calendar days the log covers (the JSON's `days`): more than one is a trip, not a day
